...
//        UILabel *lbl = [[UILabel alloc]initWithFrame:CGRectMake(70, 10, self.tableView.frame.size.width, 30)];
        UILabel *lbl = [[UILabel alloc]initWithFrame:CGRectMake(70, 0, 140, 60)];
        lbl.numberOfLines = 2;
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    if (indexPath.section==totalSection&&indexPath.row>0) {
        return 40;
    }
    return 55;
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section==totalSection) {
    ...
    if (indexPath.section == totalSection) {
        ...
        if (indexPath.row==0) {
            ...
            if (addValueArray.count>1) {
                ...
                for(NSDictionary *dInner in tmpArray) {
                    NSLog(@"Data: %@",dInner);
                    [arCells addObject:[NSIndexPath indexPathForRow:count inSection:totalSection]];
                    count++;
                }
                [addValueArray removeObjectsInArray:tmpArray];
                [tableView deleteRowsAtIndexPaths:arCells withRowAnimation:UITableViewRowAnimationBottom];
            ...
            if ([keyText isEqualToString:@"Banner - Accounts"]) {
                ...
                NSLog(@"Add Record Url : %@",urlString);
...
//                        //Execute your code
//                        AddRecord *addRecord=(AddRecord *)[viewControlles objectAtIndex:i];
//                        isExist=true;
//                        addRecord.lblTitle = @"Add New Record";
//                        addRecord.strRecord = @"addlead";
//                        [navcon popToViewController:addRecord animated:false];
//                        break;
//                    }
//                }
//                if(!isExist){
//                    AddRecord *addRecord=(AddRecord *)[self.storyboard instantiateViewControllerWithIdentifier:@"AddRecord"];
//                    addRecord.lblTitle = @"Add New Record";
//                    addRecord.strRecord = @"addlead";
//                    [navcon pushViewController:addRecord animated:false];
//                }
            }else if ([keyText isEqualToString:@"Banner - Contacts"]) {
                    //Add Contact tap
...
//                [self openWebViewMethodForAdd:urlString mTitle:@"Add New Contact"];
                ...
                for (int i = 0 ; i <viewControlles.count; i++){
                    if ([[viewControlles objectAtIndex:i] isKindOfClass:[CalendarVC  class]]) {
                        ...
                        AddRecord *addRecord=(AddRecord *)[viewControlles objectAtIndex:i];
                        isExist=true;
                        addRecord.lblTitle = @"Add New Contact";
                        addRecord.strRecord = @"addcontact";
                        [navcon popToViewController:addRecord animated:false];
                        break;
                    }
                }
...
//                        AddRecord *addRecord=(AddRecord *)[viewControlles objectAtIndex:i];
//                        isExist=true;
//                        addRecord.lblTitle = @"Add New Case";
//                        addRecord.strRecord = @"addcase";
//                        [navcon popToViewController:addRecord animated:false];
//                        break;
//                    }
//                }
...
//                        AddRecord *addRecord=(AddRecord *)[viewControlles objectAtIndex:i];
//                        isExist=true;
//                        addRecord.lblTitle = @"Add New Opportunity";
//                        addRecord.strRecord = @"addopp";
//                        [navcon popToViewController:addRecord animated:false];
//                        break;
//                    }
//                }
...
//                [[SlideNavigationController sharedInstance] toggleLeftMenu];
                ...
                [[NSUserDefaults standardUserDefaults] setObject:[NSString stringWithFormat:@"%@",[dictionary valueForKey:@"Value"]] forKey:setHeaderTitle];
...
//        NSDictionary *mDict1 = @{@"Key":@"key",@"Value":@""};
        ...
        totalSection++;
        [arrValue1 replaceObjectAtIndex:section withObject:dic1];
        for (NSDictionary *tmpDicForLbl in privillageArray) {
            if ([tmpDicForLbl objectForKey:@"MyCalendar"]) {
                section++;
                totalSection++;
            ...
            if ([tmpDicForLbl objectForKey:@"GroupCalendar"]) {
                section++;
                totalSection++;
...
//        [arrValue1 replaceObjectAtIndex:2 withObject:dicGroupCal];
        ...
        totalSection++;
        section++;
        [arrValue1 replaceObjectAtIndex:section withObject:dic2];
        
        NSDictionary *dic3=@{@"Key":@"Add",@"Value":@"Add"};
        [tblDataArray addObject:dic3];
        section++;
        [arrValue1 replaceObjectAtIndex:section withObject:dic3];
        ...
        for (NSDictionary *tmpDicForLbl in displayLblArray) {
            ...
            if ([keyStr isEqualToString:@"Events"]&&![valueStr isEqualToString:@""]) {
                ...
                [arrValue1 replaceObjectAtIndex:section+1 withObject:tmpDicForLbl];
...
//                [tmpDataAddDic setValue:@"Add Call Back/Event" forKey:@"Value"];
            ...
            if ([keyStr isEqualToString:@"Shortcuts"]&&![valueStr isEqualToString:@""]) {
                [tblDataArray addObject:tmpDicForLbl];
                [arrValue1 replaceObjectAtIndex:section+2 withObject:tmpDicForLbl];
            ...
            else if([keyStr isEqualToString:@"Banner - Accounts"]&&![valueStr isEqualToString:@""])
            {
                ...
                if ([statusStr isEqualToString:@"true"]) {
                    [tblDataArray addObject:tmpDicForLbl];
                    [arrValue1 replaceObjectAtIndex:section+3 withObject:tmpDicForLbl];
                    NSMutableDictionary *tmpDataAddDic=[[NSMutableDictionary alloc]init];
                    [tmpDataAddDic setValue:keyStr forKey:@"Key"];
                ...
                if ([statusStr isEqualToString:@"true"]) {
                    [tblDataArray addObject:tmpDicForLbl];
                    [arrValue1 replaceObjectAtIndex:section+4 withObject:tmpDicForLbl];
                ...
                [tblDataArray addObject:tmpDicForLbl];
                [arrValue1 replaceObjectAtIndex:section+5 withObject:tmpDicForLbl];
                ...
                if ([statusStr isEqualToString:@"true"]) {
                    [tblDataArray addObject:tmpDicForLbl];
                    [arrValue1 replaceObjectAtIndex:section+6 withObject:tmpDicForLbl];
                ...
                [tblDataArray addObject:tmpDicForLbl];
                [arrValue1 replaceObjectAtIndex:section+7 withObject:tmpDicForLbl];
                
                NSMutableDictionary *tmpDataAddDic=[[NSMutableDictionary alloc]init];
                [tmpDataAddDic setValue:keyStr forKey:@"Key"];
                [tmpDataAddDic setValue:[NSString stringWithFormat:@"Add %@",valueStr] forKey:@"Value"];
                [addValueTmpArray addObject:tmpDataAddDic];
                [arrAddValue replaceObjectAtIndex:7 withObject:tmpDataAddDic];

                
            }else if([keyStr isEqualToString:@"My Searches"]&&![valueStr isEqualToString:@""]) {
                [tblDataArray addObject:tmpDicForLbl];
                [arrValue1 replaceObjectAtIndex:section+8 withObject:tmpDicForLbl];
            }else if([keyStr isEqualToString:@"Recent Items"]&&![valueStr isEqualToString:@""]) {
                [tblDataArray addObject:tmpDicForLbl];
                [arrValue1 replaceObjectAtIndex:section+9 withObject:tmpDicForLbl];
        ...
        [arrValue1 replaceObjectAtIndex:section+10 withObject:dic5];
