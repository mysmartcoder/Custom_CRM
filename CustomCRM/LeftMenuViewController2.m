...
//        UILabel *lbl = [[UILabel alloc]initWithFrame:CGRectMake(70, 10, self.tableView.frame.size.width, 30)];
        ...
        [img setImageWithString:lbl.text color:[UIColor colorWithRed:0.035 green:0.275 blue:0.604 alpha:1.000]
                       circular:YES];
...
//        }
    ...
    if (indexPath.section==2&&indexPath.row>0) {
        ...
        cell.backgroundColor = [UIColor colorWithRed:0.035 green:0.275 blue:0.604 alpha:1.000];
        NSString * iconStr= @"";
...
//            [cell.btnDetail setTitle:[NSString stringWithFormat:@"%@",lblText] forState:UIControlStateNormal];
//            cell.btnDetail.hidden = false;
//            [cell.btnDetail  addTarget:self action:@selector(callBack:) forControlEvents:UIControlEventTouchUpInside];
    ...
    else
    {
        ...
        if(indexPath.section == 1)
            ...
            if(!isExist){
                ...
                NSString *urlString = [NSString stringWithFormat:
                                       @"%@/mobile_auth.asp?key=%@&topage=mobile_dashboard.asp&screenwidth=",MAIN_URL,[BaseApplication getEncryptedKey]];
...
//        NSDictionary *mDict1 = @{@"Key":@"key",@"Value":@""};
        ...
        [arrValue1 replaceObjectAtIndex:1 withObject:dic2];
        
        NSDictionary *dic3=@{@"Key":@"Add",@"Value":@"Add"};
        [tblDataArray addObject:dic3];
        [arrValue1 replaceObjectAtIndex:2 withObject:dic3];
        ...
        for (NSDictionary *tmpDicForLbl in displayLblArray) {
            ...
            if ([keyStr isEqualToString:@"Events"]&&![valueStr isEqualToString:@""]) {
                ...
                [arrValue1 replaceObjectAtIndex:3 withObject:tmpDicForLbl];
                ...
                [arrAddValue replaceObjectAtIndex:5 withObject:tmpDataAddDic];
                
            }
            if ([keyStr isEqualToString:@"Shortcuts"]&&![valueStr isEqualToString:@""]) {
                [tblDataArray addObject:tmpDicForLbl];
                [arrValue1 replaceObjectAtIndex:4 withObject:tmpDicForLbl];
        ...
        [arrValue1 replaceObjectAtIndex:12 withObject:dic5];
